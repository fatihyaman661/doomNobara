...
(doom! :input
       ...
       (ivy +prescient -childframe -fuxxy +icons)               ; a search engine for love and life
       ...
       (org +roam +gnuplot +brain +pretty +journal +jupyter +noter +pomodoro +dragndrop +hugo +pandoc +present)               ; organize your plain life in plain text
